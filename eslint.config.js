      ...
      "sort/imports": [
        "warn",
        {
          groups: [
            ...
            { order: 70, regex: "^(.*)root(/)layouts(.*)$" },
            { order: 80, regex: "^(.*)root(/)widgets(/)(.*)$" },
            { order: 90, regex: "^(.*)root(/)features(/)(.*)$" },
            { order: 100, regex: "^(.*)root(/)entities(/)(.*)$" },
            { order: 110, regex: "^(.*)root(/)shared(/)(.*)$" },
            { order: 120, type: "other" },
            { order: 130, regex: "\\.(png|jpg|svg)$" },
          ],
          separator: "\n",
        },
      ],
